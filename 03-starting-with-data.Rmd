...
that contains the survey data from figshare, and we will use `read_tsv()` from
the **`readr`** package (one of the packages in the **`tidyverse`**) to load
into memory the content of the CSV file as a modern `data.frame` (also known as
a "tibble"). Inside the download.file command, the first entry is a character string with the source URL 
...
<!-- When we did `str(variants)` we saw that several of the columns consist of -->
...
<!-- variants <- read.csv("data/portal_data_joined.csv", stringsAsFactors = TRUE) -->
<!-- str(variants) -->
<!-- variants <- read.csv("data/portal_data_joined.csv", stringsAsFactors = FALSE) -->
<!-- str(variants) -->
<!-- ## Convert the column "plot_type" into a factor -->
<!-- variants$plot_type <- factor(variants$plot_type) -->
<!-- ``` -->
